...
\centering
\includesvg[width=0.4\textwidth]{small\_MinION\_collection\_read\_0\_pie\_merge.svg}
\includesvg[width=0.4\textwidth]{small\_MinION\_collection\_read\_0\_tree.svg}
...
\begin{figure}[h]
\centering
\includesvg[width=0.8\textwidth]{family\_Propionibacteriales\_confusion\_matrix.svg}
\includesvg[width=0.8\textwidth]{family\_Propionibacteriales\_graph\_reads.svg}
